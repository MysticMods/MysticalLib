...
public class RenderUtil {
  ...
  public static void drawCrystal(@Nonnull BufferBuilder buf, float x, float y, float z, float r, float g, float b, float a, float rotation, float hsize,
    ...
    buf.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(r, g, b, a).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z).endVertex();
    buf.pos(pos2X, pos2Y, pos2Z).tex(minU, minV).color(r, g, b, a).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z).endVertex();
    buf.pos(pos3X, pos3Y, pos3Z).tex(maxU, minV).color(r, g, b, a).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z).endVertex();

    buf.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(r, g, b, a).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z).endVertex();
    buf.pos(pos3X, pos3Y, pos3Z).tex(minU, minV).color(r, g, b, a).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z).endVertex();
    buf.pos(pos4X, pos4Y, pos4Z).tex(maxU, minV).color(r, g, b, a).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z).endVertex();

    buf.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(r, g, b, a).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z).endVertex();
    buf.pos(pos4X, pos4Y, pos4Z).tex(minU, minV).color(r, g, b, a).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z).endVertex();
    buf.pos(pos5X, pos5Y, pos5Z).tex(maxU, minV).color(r, g, b, a).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z).endVertex();

    buf.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(r, g, b, a).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z).endVertex();
    buf.pos(pos5X, pos5Y, pos5Z).tex(minU, minV).color(r, g, b, a).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z).endVertex();
    buf.pos(pos2X, pos2Y, pos2Z).tex(maxU, minV).color(r, g, b, a).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z).endVertex();

    buf.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(r, g, b, a).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z).endVertex();
    buf.pos(pos2X, pos2Y, pos2Z).tex(minU, maxV).color(r, g, b, a).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z).endVertex();
    buf.pos(pos3X, pos3Y, pos3Z).tex(maxU, maxV).color(r, g, b, a).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z).endVertex();

    buf.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(r, g, b, a).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z).endVertex();
    buf.pos(pos3X, pos3Y, pos3Z).tex(minU, maxV).color(r, g, b, a).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z).endVertex();
    buf.pos(pos4X, pos4Y, pos4Z).tex(maxU, maxV).color(r, g, b, a).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z).endVertex();

    buf.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(r, g, b, a).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z).endVertex();
    buf.pos(pos4X, pos4Y, pos4Z).tex(minU, maxV).color(r, g, b, a).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z).endVertex();
    buf.pos(pos5X, pos5Y, pos5Z).tex(maxU, maxV).color(r, g, b, a).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z).endVertex();

    buf.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(r, g, b, a).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z).endVertex();
    buf.pos(pos5X, pos5Y, pos5Z).tex(minU, maxV).color(r, g, b, a).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z).endVertex();
    buf.pos(pos2X, pos2Y, pos2Z).tex(maxU, maxV).color(r, g, b, a).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z).endVertex();
  }
  ...
  public static void drawCrystal(@Nonnull BufferBuilder b, float x, float y, float z, float rotation, float hsize, float ysize, float minU, float minV,
    ...
    Vec3d normal8 = new Vec3d(-normal1.z, normal1.y, -normal1.x).scale(-1.0f);
    normal1 = new Vec3d(normal1.x, -normal1.y, normal1.z).scale(-1.0f);
    b.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z)
        .endVertex();
    b.pos(pos2X, pos2Y, pos2Z).tex(minU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z).endVertex();
    b.pos(pos3X, pos3Y, pos3Z).tex(maxU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal1.x, (float) normal1.y, (float) normal1.z).endVertex();

    b.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z)
        .endVertex();
    b.pos(pos3X, pos3Y, pos3Z).tex(minU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z).endVertex();
    b.pos(pos4X, pos4Y, pos4Z).tex(maxU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal2.x, (float) normal2.y, (float) normal2.z).endVertex();

    b.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z)
        .endVertex();
    b.pos(pos4X, pos4Y, pos4Z).tex(minU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z).endVertex();
    b.pos(pos5X, pos5Y, pos5Z).tex(maxU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal3.x, (float) normal3.y, (float) normal3.z).endVertex();

    b.pos(pos1X, pos1Y, pos1Z).tex((minU + maxU) / 2.0f, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z)
        .endVertex();
    b.pos(pos5X, pos5Y, pos5Z).tex(minU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z).endVertex();
    b.pos(pos2X, pos2Y, pos2Z).tex(maxU, minV).color(255, 255, 255, 255).func_225584_a_((float) normal4.x, (float) normal4.y, (float) normal4.z).endVertex();

    b.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(255, 255, 255, 255).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z)
        .endVertex();
    b.pos(pos2X, pos2Y, pos2Z).tex(minU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z).endVertex();
    b.pos(pos3X, pos3Y, pos3Z).tex(maxU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal5.x, (float) normal5.y, (float) normal5.z).endVertex();

    b.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(255, 255, 255, 255).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z)
        .endVertex();
    b.pos(pos3X, pos3Y, pos3Z).tex(minU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z).endVertex();
    b.pos(pos4X, pos4Y, pos4Z).tex(maxU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal6.x, (float) normal6.y, (float) normal6.z).endVertex();

    b.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(255, 255, 255, 255).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z)
        .endVertex();
    b.pos(pos4X, pos4Y, pos4Z).tex(minU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z).endVertex();
    b.pos(pos5X, pos5Y, pos5Z).tex(maxU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal7.x, (float) normal7.y, (float) normal7.z).endVertex();

    b.pos(pos6X, pos6Y, pos6Z).tex((minU + maxU) / 2.0f, minV).color(255, 255, 255, 255).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z)
        .endVertex();
    b.pos(pos5X, pos5Y, pos5Z).tex(minU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z).endVertex();
    b.pos(pos2X, pos2Y, pos2Z).tex(maxU, maxV).color(255, 255, 255, 255).func_225584_a_((float) normal8.x, (float) normal8.y, (float) normal8.z).endVertex();
  }

  public static ItemCameraTransforms.TransformType itemTransformType = ItemCameraTransforms.TransformType.NONE;

  public static void setTransform(@Nonnull ItemCameraTransforms.TransformType t) {
    itemTransformType = t;
  }
