...
public class ItemKnifeBase extends ItemToolBase {
  ...
  public ItemKnifeBase(String name, ToolMaterial material) {
    super(name, MaterialTypes.stats(material) != null ? (Math.max(1f, MaterialTypes.stats(material).damage - 1.0f)) : 1.0f, MaterialTypes.stats(material) != null ? MaterialTypes.stats(material).speed : -2.0f, material, BLOCKS);
  }
